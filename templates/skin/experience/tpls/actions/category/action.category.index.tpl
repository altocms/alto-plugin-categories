            ...
            <table class="topic-list">
                <tr>
                    <td class="topic-list-title-container">
                        ...
                        {if $oTopic->isVoteInfoShow() || Config::Get('view.show_rating')}
                            <span class="label label-{if $oTopic->getRating() > 0}success{else}danger{/if}">{if $oTopic->getRating() > 0}+{/if}{$oTopic->getRating()}</span>
                        {/if}
                    </td>
